  ...
  return (
    <>
      <div className={classes.container}>
        <div>
          <p className={classes.text}>Our projects</p>
          <h3 className={classes.header}>Some of Our Finest Work</h3>
        </div>
      ...
      <div className={classes.itemContainer}>
        ...
        <PortfolioItem source="/ozonowanie.png" title="EOS - ozonowanie | Kraków" text="Strona Główna + podstrona z karuzelą." />
